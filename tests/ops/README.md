...
- `run_team_repo_surface_acceptance.sh`:
  ...
  Typical invocation:
  `CONMAN_BASE_URL=http://127.0.0.1:3001 CONMAN_LOGIN_EMAIL=... CONMAN_LOGIN_PASSWORD=... CONMAN_ACCEPTANCE_REPO_PATH=... ./tests/ops/run_team_repo_surface_acceptance.sh --strict`
