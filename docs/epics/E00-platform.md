...
pub fn build_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/api/repos/:repoId", get(not_implemented))
        .route("/api/repos/:repoId/settings", axum::routing::patch(not_implemented))
        .route("/api/repos/:repoId/members", get(not_implemented))
        .route("/api/teams/:teamId/invites", axum::routing::post(not_implemented))

        // Workspaces stubs (E04)
        .route("/api/repos/:repoId/workspaces", get(not_implemented).post(not_implemented))
        .route("/api/repos/:repoId/workspaces/:workspaceId", get(not_implemented).patch(not_implemented))
        .route("/api/repos/:repoId/workspaces/:workspaceId/reset", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/workspaces/:workspaceId/sync-integration", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/workspaces/:workspaceId/files", get(not_implemented).put(not_implemented).delete(not_implemented))
        .route("/api/repos/:repoId/workspaces/:workspaceId/checkpoints", axum::routing::post(not_implemented))

        // Changesets stubs (E05)
        .route("/api/repos/:repoId/changesets", get(not_implemented).post(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId", get(not_implemented).patch(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/submit", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/resubmit", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/review", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/queue", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/move-to-draft", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/diff", get(not_implemented))
        .route("/api/repos/:repoId/changesets/:changesetId/comments", get(not_implemented).post(not_implemented))

        // Releases stubs (E08)
        .route("/api/repos/:repoId/releases", get(not_implemented).post(not_implemented))
        .route("/api/repos/:repoId/releases/:releaseId", get(not_implemented))
        .route("/api/repos/:repoId/releases/:releaseId/changesets", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/releases/:releaseId/reorder", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/releases/:releaseId/assemble", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/releases/:releaseId/publish", axum::routing::post(not_implemented))

        // Environments + deployments stubs (E09)
        .route("/api/repos/:repoId/environments", get(not_implemented).patch(not_implemented))
        .route("/api/repos/:repoId/environments/:envId/deploy", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/environments/:envId/promote", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/environments/:envId/rollback", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/deployments", get(not_implemented))

        // Temp environments stubs (E10)
        .route("/api/repos/:repoId/temp-envs", get(not_implemented).post(not_implemented))
        .route("/api/repos/:repoId/temp-envs/:tempEnvId/extend", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/temp-envs/:tempEnvId/undo-expire", axum::routing::post(not_implemented))
        .route("/api/repos/:repoId/temp-envs/:tempEnvId", axum::routing::delete(not_implemented))

        // Jobs stubs (E06)
        .route("/api/repos/:repoId/jobs", get(not_implemented))
        .route("/api/repos/:repoId/jobs/:jobId", get(not_implemented))
