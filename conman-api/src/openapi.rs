...
const ROUTES: &[RouteDoc] = &[
    ...
    RouteDoc {
        method: "post",
        path: "/api/teams/{teamId}/repos",
        summary: "Create repository under team",
        tag: "teams",
        protected: true,
    },
    RouteDoc {
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/apps",
        summary: "Create app in repository",
        tag: "apps",
        protected: true,
    },
    RouteDoc {
        method: "patch",
        path: "/api/repos/{appId}/apps/{surfaceId}",
        summary: "Update app in repository",
        tag: "apps",
        protected: true,
    },
    RouteDoc {
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/workspaces",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/workspaces/{workspaceId}",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/workspaces/{workspaceId}/reset",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/workspaces/{workspaceId}/sync-integration",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/workspaces/{workspaceId}/files",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/workspaces/{workspaceId}/checkpoints",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/changesets",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/changesets/{changesetId}",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/changesets/{changesetId}/submit",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/changesets/{changesetId}/resubmit",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/changesets/{changesetId}/review",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/changesets/{changesetId}/queue",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/changesets/{changesetId}/move-to-draft",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/changesets/{changesetId}/diff",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/changesets/{changesetId}/comments",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/releases/{releaseId}",
        summary: "Get release",
        tag: "releases",
        protected: true,
    },
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/releases/{releaseId}/changesets",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/releases/{releaseId}/reorder",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/releases/{releaseId}/assemble",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/releases/{releaseId}/publish",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/environments",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/runtime-profiles",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/runtime-profiles/{profileId}",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/runtime-profiles/{profileId}/secrets/{key}/reveal",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/environments/{envId}/deploy",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/environments/{envId}/promote",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/environments/{envId}/rollback",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/deployments",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/temp-envs",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/temp-envs/{tempEnvId}/extend",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{appId}/temp-envs/{tempEnvId}/undo-expire",
    ...
    RouteDoc {
        method: "delete",
        path: "/api/repos/{appId}/temp-envs/{tempEnvId}",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{appId}/jobs/{jobId}",
...
mod tests {
    ...
    fn openapi_includes_core_paths() {
        ...
        assert!(paths.contains_key("/api/repos/{appId}/changesets/{changesetId}/submit"));
        assert!(paths.contains_key("/api/repos/{appId}/releases/{releaseId}/publish"));
    }

    #[test]
    fn protected_routes_have_security() {
        let doc = openapi_document();
        let submit = &doc["paths"]["/api/repos/{appId}/changesets/{changesetId}/submit"]["post"];
