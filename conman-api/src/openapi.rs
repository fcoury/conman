...
const ROUTES: &[RouteDoc] = &[
    ...
    RouteDoc {
        method: "patch",
        path: "/api/repos/{repoId}/apps/{appId}",
    ...
    RouteDoc {
        method: "patch",
        path: "/api/repos/{repoId}/settings",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/workspaces/{workspaceId}",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/workspaces/{workspaceId}/reset",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/workspaces/{workspaceId}/sync-integration",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/workspaces/{workspaceId}/files",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/changesets",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/changesets/{changesetId}",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/changesets/{changesetId}/submit",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/changesets/{changesetId}/resubmit",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/changesets/{changesetId}/review",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/changesets/{changesetId}/queue",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/changesets/{changesetId}/move-to-draft",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/changesets/{changesetId}/diff",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/changesets/{changesetId}/comments",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/releases",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/releases/{releaseId}",
        summary: "Get release",
        tag: "releases",
        protected: true,
    },
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/releases/{releaseId}/changesets",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/releases/{releaseId}/reorder",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/releases/{releaseId}/assemble",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/releases/{releaseId}/publish",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/environments",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/runtime-profiles",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/runtime-profiles/{profileId}",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/runtime-profiles/{profileId}/secrets/{key}/reveal",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/environments/{envId}/deploy",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/environments/{envId}/promote",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/environments/{envId}/rollback",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/deployments",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/temp-envs",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/temp-envs/{tempEnvId}/extend",
    ...
    RouteDoc {
        method: "post",
        path: "/api/repos/{repoId}/temp-envs/{tempEnvId}/undo-expire",
    ...
    RouteDoc {
        method: "delete",
        path: "/api/repos/{repoId}/temp-envs/{tempEnvId}",
    ...
    RouteDoc {
        method: "get",
        path: "/api/repos/{repoId}/jobs/{jobId}",
...
mod tests {
    ...
    fn protected_routes_have_security() {
        let doc = openapi_document();
        let submit = &doc["paths"]["/api/repos/{repoId}/changesets/{changesetId}/submit"]["post"];
